...
class Scraper:
    def __init__(
        ...
        :param str url: Base survey URL to paginate through.
        :param int max_entries: Soft limit on the number of new entries to
    ...
    def scrape_data(self, existing_urls=None):
        ...
        :param set[str] existing_urls: URLs that have already been ingested and
            should terminate scraping if encountered again.
        :return: List of raw entry dictionaries extracted from the survey.
        :rtype: list[dict]
        """
    ...
    def _get_html(self, url):
        ...
        :return: Decoded UTF-8 HTML payload for ``url``.
        :rtype: str
        """
    ...
    def _extract_raw_data(self, html):
        ...
        :param str html: HTML document returned from GradCafe.
        :return: Sequence of raw entry dictionaries containing the scraped
            fields. Returns an empty list when the page contains no applicant
            rows.
        :rtype: list[dict]
        """
